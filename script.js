...
var Game = {
    ...
    endGameMenu: function (text) {
        ...
        Pong.context.font = '45px "Press Start 2P"';
        
		Pong.context.fillStyle = '#000000'; // change color so we get black backround for text
    ...
    menu: function () {
        ...
        this.context.fillText('PRESS UP TO START',
            this.canvas.width / 2,
    ...
    draw: function () {
        ...
        this.context.strokeStyle = '#ffde56';
        this.context.stroke();
...
if ("fonts" in document) {
    document.fonts.load('50px "Press Start 2P"').then(() => {
        Pong.initialize();
    });
} else {
    Pong.initialize();
